...
// The object storage client authenticates via Application Default Credentials.
// In Docker deployments set GOOGLE_APPLICATION_CREDENTIALS to a service-account
// key file path, or attach a service account to the VM for implicit auth.
